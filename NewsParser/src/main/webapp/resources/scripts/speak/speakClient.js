var speakWorker;
try {
  speakWorker = new Worker('/resources/scripts/speak/speakWorker.js');
} catch(e) {
...
function speak(text, args) {
  ...
  function playHTMLAudioElement(wav) {
    ...
    document.getElementById("audio").innerHTML=("<audio id=\"player\" src=\"data:audio/x-wav;base64,"
        + encode64(wav) + "\" controls preload=\"auto\">");
